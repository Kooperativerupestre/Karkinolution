...
void GodotEntityStorage::_bind_methods() {
	...
	godot::ClassDB::bind_method(godot::D_METHOD("delete", "id"),
								&GodotEntityStorage::remove);
	godot::ClassDB::bind_method(godot::D_METHOD("remove", "id"),
								&GodotEntityStorage::remove);
	godot::ClassDB::bind_method(godot::D_METHOD("clear"),
								&GodotEntityStorage::clear);
	godot::ClassDB::bind_method(godot::D_METHOD("get", "id"),
								&GodotEntityStorage::get);
	godot::ClassDB::bind_method(godot::D_METHOD("list_ids"),
								&GodotEntityStorage::list_ids);
	...
	godot::ClassDB::bind_method(godot::D_METHOD("has", "id"),
								&GodotEntityStorage::has);
	godot::ClassDB::bind_method(godot::D_METHOD("size"),
								&GodotEntityStorage::size);
}
...
godot::Variant GodotEntityStorage::get(std::uint64_t id) const {
	...
	return std::visit([](const auto &entity) -> godot::Variant {
