...
namespace {
    ...
    char32_t custom_towupper(char32_t cp) {
        ...
        static const std::unordered_map<char32_t, char32_t> lowercase_to_uppercase = {
            {U'á', U'Á'}, {U'é', U'É'}, {U'í', U'Í'}, {U'ó', U'Ó'}, {U'ú', U'Ú'}, {U'ý', U'Ý'},
            {U'ā', U'Ā'}, {U'ē', U'Ē'}, {U'ī', U'Ī'}, {U'ō', U'Ō'}, {U'ū', U'Ū'}, {U'ȳ', U'Ȳ'}
        };
...
const std::unordered_map<std::string_view, Pool::CommandFunc> Pool::commands = {
    {"v", []() { return Pools::vowels.pick(); }},
    {"lv", []() { return Pools::long_vowels.pick(); }},
    {"hv", []() { return Pools::high_vowels.pick(); }},
    {"gv", []() { return Pools::general_vowels.pick(); }},
    {"p", []() { return Pools::plosives.pick(); }},
    {"f", []() { return Pools::fricatives.pick(); }},
    {"l", []() { return Pools::liquids.pick(); }},
    {"n", []() { return Pools::nasals.pick(); }},
    {"a", []() { return Pools::approximants.pick(); }},
    {"c", []() { return Pools::consonants.pick(); }}
};
...
std::string gen_name() {
    static const std::vector<std::pair<std::string, double>> patterns = {
        {"c/gv/gv/a", 2.0},
        {"c/hv/a/v", 2.0},
        {"hv/v/c/f", 1.0}
    };
