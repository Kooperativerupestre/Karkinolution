...
CreatureMorphologyGenome scramble(const CreatureMorphologyGenome &g1,
								  const CreatureMorphologyGenome &g2);

CreatureSkeletonGenome scramble(const CreatureSkeletonGenome &g1, const CreatureSkeletonGenome &g2);

CreatureMuscleGenome scramble(const CreatureMuscleGenome &g1, const CreatureMuscleGenome &g2);


CreatureVitalGenome scramble(const CreatureVitalGenome &g1, const CreatureVitalGenome &g2);


CreatureMetabolismGenome scramble(const CreatureMetabolismGenome &g1,
								  const CreatureMetabolismGenome &g2);

ReproductionOviparous scramble(const ReproductionOviparous &g1, const ReproductionOviparous &g2);


ReproductionViviparous scramble(const ReproductionViviparous &g1, const ReproductionViviparous &g2);
...
*/
ReproductiveGenome scramble(const ReproductiveGenome &g1, const ReproductiveGenome &g2);

BrainGenome scramble(const BrainGenome &g1, const BrainGenome &g2);

EmbryoBodyGenome scramble(const EmbryoBodyGenome &g1, const EmbryoBodyGenome &g2);

EmbryoMorphologyGenome scramble(const EmbryoMorphologyGenome &g1, const EmbryoMorphologyGenome &g2);
