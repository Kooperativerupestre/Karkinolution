...
MetabolismTransformations metabolism_transformations(
    float max_reserved_energy,
    float max_energy,
    float energy
) {
    return MetabolismTransformations{
        std::flat_map<Genomes::Resource, std::vector<MetabolismRelation>>{
            {Genomes::Resource::RESERVED_ENERGY, {
                {Genomes::Resource::RESERVED_ENERGY, MetabolismTrait::MAX_RESERVED_ENERGY, Efficiency{max_reserved_energy}},
...
bool CreatureGenomes::exists_specie(CreatureSpecies c_s) const {
    return g_creatures.contains(c_s) && g_core.contains(c_s) && g_brain.contains(c_s) && g_embryos.contains(c_s);
}
...
Genome CreatureGenomes::get_genome(CreatureSpecies c_s) const {
    ...
    return Genome{
        .creature_genome = g_creatures.at(c_s),
...
void Populate::populate_crocodile(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::CROCODILE, CreatureGenome{
        .metabolism = Metabolism::MetabolismGenome{
            .max_energy = 100.0f,
            ...
            .growth_rates = Metabolism::GrowthRates{.max_energy = 0.30f, .energy = 0.45f, .max_reserved_energy = 0.25f}
        },
        .vital = Vital::VitalGenome{
            .max_life = 100.0f,
        ...
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.55f},
            .average_muscles = Muscle{27.0f},
            .average_muscle_efficiency = MuscleEfficiency{0.80f},
            .average_muscle_quality = MuscleQuality{0.85f},
            .growth_rates = MuscleStructure::GrowthRates{.muscle = 0.40f},
    ...
    creature_genomes.add(CreatureSpecies::CROCODILE, EmbryoGenome{
        ...
        .morphology = Genomes::EmbryoGenomes::Morphology{.volume_growth = 0.18f, .average_volume = 0.30f}
    });
    creature_genomes.add(CreatureSpecies::CROCODILE, CoreGenome{
        .properties = movement_properties(true, false), .vision_radius = VisionRadius{20.0},
        .temperament = Temperament::AGGRESSIVE, .specie = CreatureSpecies::CROCODILE
    });
...
void Populate::populate_fish(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::FISH, CreatureGenome{
        .metabolism = Metabolism::MetabolismGenome{
            .max_energy = 10.0f, .max_reserved_energy = 4.0f,
            ...
            .growth_rates = Metabolism::GrowthRates{.max_energy = 0.55f, .energy = 0.70f, .max_reserved_energy = 0.45f}
        },
        .vital = Vital::VitalGenome{
            .max_life = 9.0f, .average_immunity = Immunity{0.35f}, .average_health = Health{0.45f},
            .average_age = Age{10.0f}, .transformations = vital_transformations(0.50f),
            .growth_rates = Vital::GrowthRates{.life = 0.50f}
        },
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.70f}, .average_muscles = Muscle{1.0f},
            .average_muscle_efficiency = MuscleEfficiency{0.55f}, .average_muscle_quality = MuscleQuality{0.45f},
            .growth_rates = MuscleStructure::GrowthRates{.muscle = 0.65f},
    ...
    creature_genomes.add(CreatureSpecies::FISH, EmbryoGenome{
        ...
        .morphology = Genomes::EmbryoGenomes::Morphology{.volume_growth = 0.25f, .average_volume = 0.20f}
    });
    creature_genomes.add(CreatureSpecies::FISH, CoreGenome{
        .properties = movement_properties(true, false), .vision_radius = VisionRadius{5.0},
        .temperament = Temperament::PASSIVE, .specie = CreatureSpecies::FISH
    });
...
void Populate::populate_crab(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::CRAB, CreatureGenome{
        .metabolism = Metabolism::MetabolismGenome{
            .max_energy = 40.0f, .max_reserved_energy = 15.0f,
            ...
            .growth_rates = Metabolism::GrowthRates{.max_energy = 0.40f, .energy = 0.60f, .max_reserved_energy = 0.35f}
        },
        .vital = Vital::VitalGenome{
            .max_life = 30.0f, .average_immunity = Immunity{0.45f}, .average_health = Health{0.55f},
            .average_age = Age{30.0f}, .transformations = vital_transformations(0.55f),
            .growth_rates = Vital::GrowthRates{.life = 0.40f}
        },
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.65f}, .average_muscles = Muscle{7.5f},
            .average_muscle_efficiency = MuscleEfficiency{0.65f}, .average_muscle_quality = MuscleQuality{0.55f},
            .growth_rates = MuscleStructure::GrowthRates{.muscle = 0.50f},
    ...
    creature_genomes.add(CreatureSpecies::CRAB, EmbryoGenome{
        ...
        .morphology = Genomes::EmbryoGenomes::Morphology{.volume_growth = 0.22f, .average_volume = 0.25f}
    });
    creature_genomes.add(CreatureSpecies::CRAB, CoreGenome{
        .properties = movement_properties(false, true), .vision_radius = VisionRadius{2.0},
        .temperament = Temperament::NEUTRAL, .specie = CreatureSpecies::CRAB
    });
...
void Populate::populate_hippopotamus(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::HIPPOPOTAMUS, CreatureGenome{
        .metabolism = Metabolism::MetabolismGenome{
            .max_energy = 85.0f, .max_reserved_energy = 35.0f,
            ...
            .growth_rates = Metabolism::GrowthRates{.max_energy = 0.25f, .energy = 0.35f, .max_reserved_energy = 0.20f}
        },
        .vital = Vital::VitalGenome{
            .max_life = 150.0f, .average_immunity = Immunity{0.70f}, .average_health = Health{0.90f},
            .average_age = Age{60.0f}, .transformations = vital_transformations(0.75f),
            .growth_rates = Vital::GrowthRates{.life = 0.25f}
        },
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.80f}, .average_muscles = Muscle{20.0f},
            .average_muscle_efficiency = MuscleEfficiency{0.75f}, .average_muscle_quality = MuscleQuality{0.80f},
            .growth_rates = MuscleStructure::GrowthRates{.muscle = 0.35f},
    ...
    creature_genomes.add(CreatureSpecies::HIPPOPOTAMUS, EmbryoGenome{
        .body = Genomes::EmbryoGenomes::BodyGenome{.average_max_energy = 0.65f, .average_max_life = 0.50f, .average_health = 0.70f},
        .morphology = Genomes::EmbryoGenomes::Morphology{.volume_growth = 0.15f, .average_volume = 0.35f}
    });
    creature_genomes.add(CreatureSpecies::HIPPOPOTAMUS, CoreGenome{
        .properties = movement_properties(true, true), .vision_radius = VisionRadius{10.0},
        .temperament = Temperament::TERRITORIAL, .specie = CreatureSpecies::HIPPOPOTAMUS
    });
