...
void Populate::populate_crocodile(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::CROCODILE, CreatureGenome{
        .metabolism = Metabolism::MetabolismGenome{
            ...
            .growth_rates = Metabolism::GrowthRates{
                .max_energy = 0.30f,
                .energy = 0.45f,
    ...
    creature_genomes.add(CreatureSpecies::CROCODILE, EmbryoGenome{
        .body = Genomes::EmbryoGenomes::BodyGenome{
            .average_max_energy = 0.55f,
            .average_max_life = 0.45f,
            .average_health = 0.60f
        },
        .morphology = Genomes::EmbryoGenomes::Morphology{
            .volume_growth = 0.18f,
    ...
    creature_genomes.add(CreatureSpecies::CROCODILE, CoreGenome{
        .properties = movement_properties(true, false),
        .vision_radius = VisionRadius{20.0},
        .temperament = Temperament::AGGRESSIVE,
        .specie = CreatureSpecies::CROCODILE
    });

    creature_genomes.add(CreatureSpecies::CROCODILE, BrainGenome{
        .average_sociability = 0.20f
    });
}
...
void Populate::populate_fish(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::FISH, CreatureGenome{
        ...
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.70f},
        ...
        .skeleton = SkeletonStructure::SkeletonGenome{
            .shared_volume = SharedVolume{0.15f},
    ...
    creature_genomes.add(CreatureSpecies::FISH, BrainGenome{
        .average_sociability = 0.70f
    });
}
...
void Populate::populate_crab(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::CRAB, CreatureGenome{
        ...
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.65f},
        ...
        .skeleton = SkeletonStructure::SkeletonGenome{
            .shared_volume = SharedVolume{0.30f},
    ...
    creature_genomes.add(CreatureSpecies::CRAB, CoreGenome{
        .properties = movement_properties(false, true),
        .vision_radius = VisionRadius{2.0},
        .temperament = Temperament::NEUTRAL,
        .specie = CreatureSpecies::CRAB
    });

    creature_genomes.add(CreatureSpecies::CRAB, BrainGenome{
        .average_sociability = 0.40f
    });
}
...
void Populate::populate_hippopotamus(CreatureGenomes& creature_genomes) {
    ...
    creature_genomes.add(CreatureSpecies::HIPPOPOTAMUS, CreatureGenome{
        ...
        .muscle = MuscleStructure::MuscleGenome{
            .shared_volume = SharedVolume{0.80f},
        ...
        .skeleton = SkeletonStructure::SkeletonGenome{
            .shared_volume = SharedVolume{0.90f},
