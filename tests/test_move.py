...
def test_update_creature_position(seed:int) -> None:
    ...
    output = PresetExecutor.execute_move(MovePreset(new_coord), world.creature, world.perception, world.danger_index, world.world)
...
def test_invalid_best_pos(seed:int) -> None:
    ...
    danger_index_2 = DangerFactory.create_danger_index(perception_2, creature_2)
    output = MovementSystem.best_pos(perception_2, danger_index_2, creature_2, world.creature.position)
